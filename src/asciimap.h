...
* File: asciimap.h                                                              A CircleMUD/tbaMUD *
* Description: Header file for generating an ASCII map of the player's surroundings.               *
*                                                                                                  *
...
#ifndef __ASCIIMAP_H__
#define __ASCIIMAP_H__
